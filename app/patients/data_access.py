    ...
    with get_connection() as conn:
        with conn.cursor() as cur:
            ...
            return Patient(
                ...
                birthing_events =  birthing_events, 
                edited_at=edited_at
            )
